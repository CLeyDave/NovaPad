...
public partial class AdminOverlayVm : ObservableObject
{
    ...
    public AdminOverlayVm(IAppSettingsService settings, IOverlayService overlay, IControllerManagerService controllers, IInputProcessingService inputProcessing)
    {
        _settings = settings;
        _overlay = overlay;
    ...
    partial void OnAutoStartChanged(bool value) { if (_loading) return; _settings.Settings.Overlay.Activado = value; SaveGlobal(); }
    ...
    private void LoadCfg()
    {
        ...
        AutoStart = s.AutoStartOverlay;
        s.Overlay.Activado = s.AutoStartOverlay;
    ...
    private void RefreshStatus()
    {
        ...
        StatusText = _isRunning ? loc["OverlaySettings_Running"] : loc["OverlaySettings_Stopped"];
        CanStart = !_isRunning;
        CanStop = _isRunning;
    }
    ...
    {
        var s = _settings.Settings;
        s.AutoStartOverlay = AutoStart;
        s.Overlay.Activado = AutoStart;
